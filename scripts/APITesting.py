...
def process_json_file(input_file: str, llama_output: str, openai_output: str, gemini_output: str, deepseek_output: str, 
                      llama: LlamaInteraction, openai: OpenAIInteraction, gemini: GeminiInteraction, deepseek: DeepSeekInteraction):
    """
    ...
    try:
        ...
        with open(llama_output, 'w') as llama_f, \
            ...
            for i, item in enumerate(data, 1):
                ...
                logging.info(f"Processing question {i} with DeepSeek: {question[:50]}...")
                ...
                logging.info(f"Processing question {i} with llama: {question[:50]}...")
                ...
                logging.info(f"Processing question {i} with OpenAI: {question[:50]}...")
                ...
                logging.info(f"Processing question {i} with Gemini: {question[:50]}...")
        ...
        logging.info(f"Processing complete. Responses written to {llama_output}, {openai_output}, and {gemini_output}")
...
def main():
    ...
    # Process the files
    process_json_file(INPUT_FILE, LLAMA_OUTPUT_FILE, OPENAI_OUTPUT_FILE, GEMINI_OUTPUT_FILE, DEEPSEEK_OUTPUT_FILE, llama, openai, gemini, deepseek)
